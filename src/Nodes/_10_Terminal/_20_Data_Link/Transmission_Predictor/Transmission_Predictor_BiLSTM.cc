/*
 * Transmission_Predictor_BiLSTM.cc
 *
...
#include "Transmission_Predictor_BiLSTM.h"

Define_Module(Transmission_Predictor_BiLSTM);

void Transmission_Predictor_BiLSTM::initialize(int stage){
...
void Transmission_Predictor_BiLSTM::loadModel(){
    // Loading model
    EV << "BiLSTM model loaded "<<endl;
...
std::vector<double> Transmission_Predictor_BiLSTM::scaleFeatures(const std::vector<double>& rawFeatures){
...
double Transmission_Predictor_BiLSTM::scaleDeltaTime (double raw_delta_time){
    double scaled_delta = (raw_delta_time - mean_delta_t) / scale_delta_t;
    return scaled_delta;
}

std::vector<double> Transmission_Predictor_BiLSTM::predict(const std::vector<double>& features){
