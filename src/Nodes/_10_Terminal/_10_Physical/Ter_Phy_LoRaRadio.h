...
#ifndef TER_PHY_LORARADIO_H_
#define TER_PHY_LORARADIO_H_
...
class Ter_Phy_LoRaRadio : public FlatRadioBase
{
public:
...
public:
  Ter_Phy_LoRaRadio() = default;
  virtual ~Ter_Phy_LoRaRadio() = default;
