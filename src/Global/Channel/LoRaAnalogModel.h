...
protected:
  ...
  public:
    /**
     * Compute the Doppler-shifted reception frequency.
     * Uses the satellite receiver velocity and the line-of-sight vector
     * relative to the ground terminal to derive the radial velocity.
     * Records radialVelocity, dopplerShift and receivedFrequency vectors.
     * @return The Doppler-shifted frequency (Hz).
     */
    Hz computeDopplerFrequency(const IRadio *receiverRadio, const ITransmission *transmission) const;
