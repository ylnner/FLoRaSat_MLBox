...
#include "Global/Channel/LoRaLogNormalShadowing.h"
...
{
    if (strcmp(radioMedium->par("pathLoss").stringValue(), "LoRaLogNormalShadowing") == 0) {
    ...
    throw cRuntimeError("Unknown pathLoss. Only LoRaLogNormalShadowing is supported by the LoRaMediumCache.");
}
