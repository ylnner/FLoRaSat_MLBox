...
Register_Enum(AppPacketType, (AppPacketType::JOIN_REQUEST, AppPacketType::JOIN_REPLY, AppPacketType::DATA, AppPacketType::TXCONFIG, AppPacketType::ACK, AppPacketType::Beacon));
...
void LoRaOptions::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->PingSlot);
}
...
void LoRaOptions::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->PingSlot);
}
...
int LoRaOptions::getPingSlot() const
{
    return this->PingSlot;
}

void LoRaOptions::setPingSlot(int PingSlot)
{
    this->PingSlot = PingSlot;
}
...
LoRaOptionsDescriptor::LoRaOptionsDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(LoRaOptions)), "")
{
...
int LoRaOptionsDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "PingSlot") == 0) return baseIndex + 7;
...
std::string LoRaOptionsDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_PingSlot: return long2string(pp->getPingSlot());
        default: return "";
    }
}
...
void LoRaOptionsDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_PingSlot: pp->setPingSlot(string2long(value)); break;
...
omnetpp::cValue LoRaOptionsDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_PingSlot: return pp->getPingSlot();
...
void LoRaOptionsDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_PingSlot: pp->setPingSlot(omnetpp::checked_int_cast<int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'LoRaOptions'", field);
    }
}
...
LoRaAppPacketDescriptor::LoRaAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(LoRaAppPacket)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
std::string LoRaAppPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LoRaAppPacket *pp = omnetpp::fromAnyPtr<LoRaAppPacket>(object); (void)pp;
    switch (field) {
        case FIELD_msgType: return enum2string(static_cast<int>(pp->getMsgType()), "AppPacketType");
...
void LoRaAppPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    LoRaAppPacket *pp = omnetpp::fromAnyPtr<LoRaAppPacket>(object); (void)pp;
    switch (field) {
        case FIELD_msgType: pp->setMsgType((AppPacketType)string2enum(value, "AppPacketType")); break;
...
void LoRaAppPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    LoRaAppPacket *pp = omnetpp::fromAnyPtr<LoRaAppPacket>(object); (void)pp;
    switch (field) {
        case FIELD_msgType: pp->setMsgType((AppPacketType)value.intValue()); break;
