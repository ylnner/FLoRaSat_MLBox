...
Register_Enum(radio::LoRaRadioCommandCode, (radio::LoRaRadioCommandCode::LORA_RADIO_C_CONFIGURE));
...
LoRaConfigureRadioCommandDescriptor::LoRaConfigureRadioCommandDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(radio::LoRaConfigureRadioCommand)), "")
{
...
LoRaTransmissionRequestDescriptor::LoRaTransmissionRequestDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(radio::LoRaTransmissionRequest)), "")
{
    propertyNames = nullptr;
}
...
LoRaReceptionIndicationDescriptor::LoRaReceptionIndicationDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(radio::LoRaReceptionIndication)), "")
{
    propertyNames = nullptr;
}
