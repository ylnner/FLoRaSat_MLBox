...
protected:
    ...
    // ACHF
    Hz dopplerShiftedFrequency;         // Frequency after doppler shift
    Hz dopplerShift;                    // Frequency Doppler  Shifht
  public:
    ...
    // ACHF
    void setDopplerShiftedFrequency(Hz freq) { const_cast<Hz&>(dopplerShiftedFrequency) = freq; }
    Hz getDopplerShiftedFrequency() const { return dopplerShiftedFrequency; }

    void setDopplerShift(Hz doppler) { const_cast<Hz&>(dopplerShift) = doppler; }
    Hz getDopplerShift() const { return dopplerShift; }
