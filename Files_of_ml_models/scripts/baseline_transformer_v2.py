...
param_grid = {
    ...
    'n_heads'   : [2, 4, 8],                       # Number of projections
    'n_layers'  : [1, 2, 3, 4, 5], #[1, 2, 3],                    # Number of encoder layers
    'dropout'   : [0.1, 0.2, 0.3],  #[0.1, 0.2, 0.3, 0.4], # , 0.2                # doprout
...
''' 
dict_train_dataset_seq_8 = {} 
dict_test_dataset_seq_8  = {}
dict_val_dataset_seq_8   = {}

dict_train_dataset_seq_16 = {} 
dict_test_dataset_seq_16  = {}
dict_val_dataset_seq_16   = {}
for seed in range(num_seeds):
    ...
    X_train, y_train, X_test, y_test, X_val  , y_val, scaler = load_and_prepare_data(seq_length = 8, global_path_train=path_train, global_path_test=path_test, global_path_val=path_val)
    ...
    dict_train_dataset_seq_8[seed] = train_dataset
    dict_test_dataset_seq_8[seed]  = test_dataset
    dict_val_dataset_seq_8[seed]   = val_dataset
